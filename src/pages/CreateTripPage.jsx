...
import tipImg from "../assets/bag.jpg";
...
function DateDurationPicker({ startDate, endDate, onChange, onClose }) {
  ...
  return (
    <div className="absolute left-0 z-50 p-5 mt-2 bg-white border border-gray-200 shadow-2xl top-full rounded-2xl w-80">
      ...
      {days > 0 && (
        <div
          className="text-center text-xs font-semibold text-[#1a5c2a]
      ...
      <div className="flex gap-2">
        <button
          onClick={onClose}
          className="flex-1 py-2 text-sm text-gray-600 transition-colors border border-gray-200 rounded-xl hover:bg-gray-50"
        >
          Cancel
        </button>
        <button
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 px-4 py-10 mx-auto max-w-7xl sm:px-6 lg:py-14">
          {/* Desktop Header */}
          ...
          <div className="grid items-start grid-cols-1 gap-8 lg:grid-cols-3">
            {/* ── Center: Form card ── */}
            <div className="p-8 bg-white border border-gray-100 shadow-xl lg:col-span-2 rounded-3xl xl:p-10">
              {/* Error banner */}
              {error && (
                <div className="flex items-start gap-2 px-4 py-3 mb-5 text-sm text-red-700 border border-red-200 bg-red-50 rounded-xl">
                  <span>⚠️</span> {error}
                </div>
              )}
              ...
              <div className="grid grid-cols-1 gap-4 mb-6 sm:grid-cols-4">
                ...
                {/* ── Group Size ── */}
                <div className="mb-6">
                  <label className="flex items-center gap-2 mb-3 text-sm font-semibold text-gray-800">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="w-6 text-base font-semibold text-center text-gray-800">
                      {groupSize}
                    </span>
                    <button
                  ...
                  {BUDGET_OPTIONS.map((b) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span
                          className={`text-sm font-semibold ${active ? "text-[#1a5c2a]" : "text-gray-800"}`}
                        >
                          {b.label}
                        </span>
              ...
              <button
                ...
                disabled={loading || !isValid()}
                className="w-full py-3 text-sm font-medium text-gray-500 transition-colors border border-gray-200 rounded-2xl hover:bg-gray-50 hover:border-gray-300 disabled:opacity-40 disabled:cursor-not-allowed"
              >
              ...
              {!isValid() ? (
                ...
                <p className="flex items-center justify-center gap-1 mt-3 text-xs text-center text-gray-400">
            ...
            <div className="sticky flex flex-col gap-6 lg:col-span-1 top-6">
              <div className="p-6 bg-white border border-green-100 shadow-lg rounded-3xl">
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-base">✨</span>
                  <h3 className="text-sm font-bold text-[#1a5c2a]">
                    AI Travel Tip
                  </h3>
              ...
              <div className="p-6 bg-white border border-gray-100 shadow-lg rounded-3xl">
                ...
                <ul className="space-y-3">
                  {NEXT_STEPS.map((step, i) => (
                    ...
                    >
                      <span className="flex items-center justify-center text-sm rounded-lg w-7 h-7 bg-green-50 shrink-0">
                        {step.emoji}
                      </span>
                      {step.label}
                    </li>
